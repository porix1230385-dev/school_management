...
class UserRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $update =  [
            ...
            'email' => 'required|nullable|email|max:100|unique:users,email,' . $this->user,
            'photo' => 'sometimes|nullab    le|image|mimes:jpeg,gif,png,jpg|max:2048',
            'address' => 'required|string|min:6|max:120',
            'class_section_id' => 'sometimes|nullable',
            'nal_id' => 'required',
        ];
