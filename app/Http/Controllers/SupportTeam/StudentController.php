...
class StudentRecordController extends Controller
{
    ...
    //     $data['lastname'] = ucwords($req->name);
    ...
    // {
    //     // dd($class_id);
    //     $data['my_class'] = $mc = $this->my_class->getMC(['id' => $class_id]);
    ...
    // public function listByClassSection($class_section_id)
    // {

    //     $class_id = $this->my_class->getClassByClassSection($class_section_id)->id;
    //     $data['my_class'] = $mc = $this->my_class->getMC(['id' => $class_id]);
    //     $data['students'] = $this->student->findStudentsByClassSection($class_section_id);
    //     $data['sections'] = $this->my_class->getSectionByClassSection($class_section_id);
    ...
    //     }
    //     $student = StudentRecord::findOrFail($sr_id);
    ...
    // }
    // public function getAllStudentsAccount()
    // {
    ...
    //     return view('pages.support_team.');
    // }
