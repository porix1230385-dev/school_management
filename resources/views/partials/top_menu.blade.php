    ...
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="{{route('dashboard')}}"><img class="img-fluid"
                        src="{{ asset('assets/images/folo-splash-logo-black.png') }}" alt=""></a></div>
            <div class="dark-logo-wrapper"><a href="{{route('dashboard')}}"><img class="img-fluid"
                        src="{{ asset('assets/images/folo-splash-logo-black.png') }}" alt=""></a>
            </div>
                ...
                <li>
                    <form class="form-inline search-form">
                        <div class="search-bg"><i class="fa fa-search"></i>
                            <input class="form-control-plaintext" placeholder="Vous cherchez .....">
                        </div>
                    </form>
        ...
        <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="bookmark-box"><i data-feather="flag"></i></div>
                    <div class="bookmark-dropdown onhover-show-div">
                        <ul>
                            <li class="add-to-bookmark"><i class="bookmark-icon" data-feather="flag"></i>Français<span
                                    class="pull-right"><i data-feather="check"></i></span></li>
                            <li class="add-to-bookmark"><i class="bookmark-icon" data-feather="flag"></i>Anglais<span
                                    class="pull-right"><i data-feather=""></i></span></li>
                        </ul>
                    </div>
                </li>
                <li class="onhover-dropdown p-0">
                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <button class="btn btn-primary-light" type="button"><i data-feather="log-out"></i>
                            {{ __('Se Déconnecter') }}
                        </button>
                    </a>
